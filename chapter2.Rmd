...
The code without all the hashtags works in Rmarkdown but it was impossible to knit. You can find the code without hashtags in my folder. When knitting i got the error that the object "learning 2014 couldnt be found"

```{r}
setwd("C:/Users/Bram/Desktop/Open data science course/GitHub/IODS-project/data")
learning2014 <- read.table(file = "learning2014d.txt",
                           header = TRUE,
                          dec = ".")
learning2014
```
